...
class Waiter:
    ...
    def ask_for_chopsticks(self, left_chopstick: LockWithName, right_chopstick: LockWithName) -> None:
        with self.mutex:
    ...
    def release_chopsticks(self, left_chopstick: LockWithName, right_chopstick: LockWithName) -> None:
...
class Philosopher(Thread):
    def __init__(self, name: str, waiter: Waiter, left_chopstick: LockWithName, right_chopstick: LockWithName):
        super().__init__()
        self.name = name
        self.waiter = waiter
    ...
    def run(self) -> None:
        ...
        while dumplings > 0:
            ...
            dumplings -= 1
            print(f"{self.name} eats a dumpling. Dumpling left: {dumplings}")
...
if __name__ == "__main__":
    ...
    for thread in [philosopher_1, philosopher_2]:
        thread.join()
