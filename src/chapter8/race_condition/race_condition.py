...
class ATM(Thread):
    ...
    def transaction(self) -> None:
        ...
        # simulationg some real action here
        time.sleep(0.001)
...
def test_atms(account: BankAccount, atm_number: int = 1000) -> None:
    atms: T.List[ATM] = []
    # create `atm_number` threads that will deposit and withdraw money from account concurrently
...
if __name__ == "__main__":
    atm_number = 1000
    # greatly improve the chance of an operation being interrupted by thread switch, thus synchronization effectively.
